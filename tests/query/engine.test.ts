...
describe('QueryEngine', () => {
  ...
  it('builds from a project directory', () => {
    engine = createQueryEngine(path.join(FIXTURES, 'simple-project'), makeSimpleLogger());
  ...
  describe('searchByPattern', () => {
    it('finds classes', () => {
      engine = createQueryEngine(path.join(FIXTURES, 'angular-project'), makeSimpleLogger());
